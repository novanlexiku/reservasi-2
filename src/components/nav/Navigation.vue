<template>
    <nav>
        ...
        <v-toolbar-title class="text-uppercase grey--text caption">
        ...
        <v-btn v-if="loggedIn" @click="signOut" text small color="grey">
            <span>Sign Out</span>
            <v-icon right>mdi-exit-to-app</v-icon>
        </v-btn>
        <v-btn v-else text small color="grey" router to="/login">
            <span>Sign In</span>
            <v-icon right>mdi-exit-to-app</v-icon>
        </v-btn>
        </v-app-bar>
